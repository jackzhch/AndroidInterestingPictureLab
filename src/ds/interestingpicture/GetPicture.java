...
public class GetPicture {
    ...
    private class AsyncFlickrSearch extends AsyncTask<String, Void, Bitmap> {
        ...
        private Bitmap search(String searchTerm) {        
    	      ...
    	      Document doc = getRemoteXML("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=21d44a2bd23c9930126bed5caad69827&is_getty=true&tags="+searchTerm);
